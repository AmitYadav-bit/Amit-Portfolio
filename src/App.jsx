...
const GEMINI_API_KEY = 'AIzaSyD9B6CmVxaOPvnQ7mTuQAp4TCqldOTwg68';
  ...
  return (
    <div className="bg-slate-950 min-h-screen font-sans selection:bg-cyan-500/30 selection:text-cyan-100 text-slate-200">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-2">
              ...
              <button 
                ...
                className="ml-4 px-6 py-2 bg-white text-slate-900 rounded-full text-sm font-bold transition-all hover:bg-cyan-50 hover:shadow-[0_0_20px_rgba(255,255,255,0.3)]"
              >
                Let's Connect
              </button>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl">
            ...
            <h1 className="text-5xl lg:text-7xl font-bold text-white tracking-tight mb-8 leading-[1.1]">
              ...
              from <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400">Complex Data</span>
            </h1>
          ...
          <div className="bg-slate-800/50 p-8 md:p-12 rounded-3xl border border-slate-700 backdrop-blur-md shadow-2xl">
            ...
            <ExperienceItem 
              ...
              description={[
                ...
                "Investigated causes of power surges using root cause analysis, preventing 10 potential failures.",
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
        {isChatOpen && (
          <div className="mb-4 w-80 md:w-96 bg-slate-900 rounded-2xl shadow-2xl border border-slate-700 overflow-hidden flex flex-col max-h-[500px]">
            {/* Header */}
            ...
            {/* Messages Area */}
            <div className="flex-1 p-4 overflow-y-auto bg-slate-950 min-h-[300px]">
            ...
            <form onSubmit={handleSendMessage} className="p-3 bg-slate-900 border-t border-slate-800 flex gap-2">
              ...
              <button 
                ...
                className="p-2.5 bg-indigo-600 text-white rounded-full hover:bg-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
              >
                <Send size={18} />
              </button>
            </form>
